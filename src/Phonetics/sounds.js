...
export const sounds = ref({
    'm': { vowel: false, name:'Bilabial nasal', audio: new Audio('./assets/sounds/Bilabial_nasal.ogg')},
    'n': { vowel: false, name:'Alveolar nasal', audio: new Audio('./assets/sounds/Alveolar_nasal.ogg')},
    'p': { vowel: false, name:'Voiceless bilabial plosive', audio: new Audio('./assets/sounds/Voiceless_bilabial_plosive.ogg')},
    'b': { vowel: false, name:'Voiced bilabial plosive', audio: new Audio('./assets/sounds/Voiced_bilabial_plosive.ogg')},
    't': { vowel: false, name:'Voiceless alveolar plosive', audio: new Audio('./assets/sounds/Voiceless_alveolar_plosive.ogg')},
    'd': { vowel: false, name:'Voiced alveolar plosive', audio: new Audio('./assets/sounds/Voiced_alveolar_plosive.ogg')},
    'c': { vowel: false, name:'Voiceless palatal plosive', audio: new Audio('./assets/sounds/Voiceless_palatal_plosive.ogg')},
    'ɟ': { vowel: false, name:'Voiced palatal plosive', audio: new Audio('./assets/sounds/Voiced_palatal_plosive.ogg')},
    'k': { vowel: false, name:'Voiceless velar plosive', audio: new Audio('./assets/sounds/Voiceless_velar_plosive.ogg')},
    'g': { vowel: false, name:'Voiced velar plosive', audio: new Audio('./assets/sounds/Voiced_velar_plosive_02.ogg')},
    'q': { vowel: false, name:'Voiceless uvular plosive', audio: new Audio('./assets/sounds/Voiceless_uvular_plosive.ogg')},
    'ɢ': { vowel: false, audio: null},
    'ʔ': { vowel: false, name:'Glottal stop', audio: new Audio('./assets/sounds/Glottal_stop.ogg')},
